...
package raw_frs is
   ...
   MAX_NUM_PRSCRPTNS : constant := 10;
   MAX_NUM_NUMIGRS       : constant := 10;
   ...
   subtype Prscrptn_Count is Integer range 0 .. MAX_NUM_PRSCRPTNS;
   subtype Nimigr_Count is Integer range 0 .. MAX_NUM_NUMIGRS;
   ...
   type Adult_Rec is record
      ...
      mednum         : Integer       := MISS;              --  Number of prscrptn items in last 4 weeks
      ...
      nhs1           : Integer       := MISS;              --  Whether prscrptns free
      nhs2           : Integer       := MISS;              --  Whether free dental treatment
      nhs3           : Integer       := MISS;              --  Whether free eyetest
      prit           : Integer       := MISS;              --  Number of free prscrptns
      prscrpt        : Integer       := MISS;              --  Last 4 weeks: whether NHS prscrptns
      ...
      whyfrpr1       : Integer       := MISS;              --  Free prscrptn because of a benefit
      whyfrpr2       : Integer       := MISS;              --  Free prscrptn because of cert HC2
      whyfrpr3       : Integer       := MISS;              --  Free prscrptn because of medical
      whyfrpr4       : Integer       := MISS;              --  Free prscrptn because require lens
      whyfrpr5       : Integer       := MISS;              --  Free prscrptn because pregnant
      whyfrpr6       : Integer       := MISS;              --  Free prscrptn because other reason
   ...
   type Household_Rec is record
      ...
      medpay         : Integer       := MISS;              --  Whether anyone in hhld paid for something on prscrptn
      medwho01       : Integer       := MISS;              --  Person 1 paid for something on prscrptn
      medwho02       : Integer       := MISS;              --  Person 2 paid for something on prscrptn
      medwho03       : Integer       := MISS;              --  Person 3 paid for something on prscrptn
      medwho04       : Integer       := MISS;              --  Person 4 paid for something on prscrptn
      medwho05       : Integer       := MISS;              --  Person 5 paid for something on prscrptn
      medwho06       : Integer       := MISS;              --  Person 6 paid for something on prscrptn
      medwho07       : Integer       := MISS;              --  Person 7 paid for something on prscrptn
      medwho08       : Integer       := MISS;              --  Person 8 paid for something on prscrptn
      medwho09       : Integer       := MISS;              --  Person 9 paid for something on prscrptn
      medwho10       : Integer       := MISS;              --  Person 10 paid for something on prscrptn
      medwho11       : Integer       := MISS;              --  Person 11 paid for something on prscrptn
      medwho12       : Integer       := MISS;              --  Person 12 paid for something on prscrptn
      medwho13       : Integer       := MISS;              --  Person 13 paid for something on prscrptn
      medwho14       : Integer       := MISS;              --  Person 14 paid for something on prscrptn
   ...
   type Prscrptn_Rec is record
      ...
      person         : Integer       := MISS;              --  Person
      issue          : Integer       := MISS;              --  Whether Mainstage or Reissue
      med12m01       : Integer       := MISS;              --  Number of times paid for item 1 on repeat prscrptn
      med12m02       : Integer       := MISS;              --  Number of times paid for item 2 on repeat prscrptn
      med12m03       : Integer       := MISS;              --  Number of times paid for item 3 on repeat prscrptn
      med12m04       : Integer       := MISS;              --  Number of times paid for item 4 on repeat prscrptn
      med12m05       : Integer       := MISS;              --  Number of times paid for item 5 on repeat prscrptn
      med12m06       : Integer       := MISS;              --  Number of times paid for item 6 on repeat prscrptn
      med12m07       : Integer       := MISS;              --  Number of times paid for item 7 on repeat prscrptn
      med12m08       : Integer       := MISS;              --  Number of times paid for item 8 on repeat prscrptn
      med12m09       : Integer       := MISS;              --  Number of times paid for item 9 on repeat prscrptn
      med12m10       : Integer       := MISS;              --  Number of times paid for item 10 on repeat prscrptn
      med12m11       : Integer       := MISS;              --  Number of times paid for item 11 on repeat prscrptn
      med12m12       : Integer       := MISS;              --  Number of times paid for item 12 on repeat prscrptn
      med12m13       : Integer       := MISS;              --  Number of times paid for item 13 on repeat prscrptn
      medrep         : Integer       := MISS;              --  Whether item on a repeat prscrptn
      medrpnm        : Integer       := MISS;              --  Number of items on repeat prscrptn
      month          : Integer       := MISS;              --  Month code (Source)
   end record;
   ...
   type Prscrptn_Array is array( 1 .. MAX_NUM_PRSCRPTNS ) of Prscrptn_Rec;
   
   type Nimigr_Array is array( 1 .. MAX_NUM_NUMIGRS ) of Nimigr_Rec;
   ...
   type Raw_Adult is
      record
         ...
         numPrscrptns : Prscrptn_Count := 0;
         prscrptns   : Prscrptn_Array;
