...
<BODY bgcolor=#fff0dd>\n";
  ...
  {
    $string .= "<table cellpadding=0 cellspacing=0>
 <tr><td valign=top width=23><img width=19 height=19 src=../diam_cy.gif><td valign=top colspan= 3>&nbsp;<a target=_top href=../index.htm>Home page</a>&nbsp;&nbsp;<a target=_top href=../index.htm><IMG width=24 height=24 border=0 SRC=../backplat.gif align=top></a></tr>
 <tr><td><td valign=top width=23><img width=19 height=19 src=../diam_rd.gif><td valign=top colspan= 2>&nbsp;<a target=_top href=../gsoft.htm>G-Soft: Ada &amp; utilities</a>&nbsp;&nbsp;<a target=_top href=../gsoft.htm><IMG width=24 height=24 border=0 SRC=../backplat.gif align=top></a>
     <td width=40><td valign=bottom rowspan=2><a target=_top href=../unzipada.htm><img border=0 width=137 height=30
          src=../uza_logo.jpg></a></td></tr>
 <tr><td><td><td valign=top width=23><img width=19 height=19 src=../diam_yl.gif><td valign=top>&nbsp;<a target=_top href=../unzipada.htm>Unzip-Ada</a>&nbsp;&nbsp;<a target=_top href=../unzipada.htm><IMG width=24 height=24 border=0 SRC=../backplat.gif align=top></a></tr>
</table>";
  }
  if ($adafile ne "")
  {
...
sub create_footer
{
  ...
  UnZip-Ada: Ada decompression library for zipped files (.zip).
...
sub create_index_file
{
  ...
  print INDEX <<"EOF";
<HTML>
<HEAD><TITLE>UnZip-Ada Source Browser</TITLE>
<meta name=\"keywords\" content=\"Ada, zip, unzip, pkzip, pkunzip, programming\">
<link rel=\"Shortcut Icon\" href=../zip.ico>
</HEAD>
<FRAMESET COLS='250,*'>
