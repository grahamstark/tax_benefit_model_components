...
package Text_Utils is
   ...
   subtype Unbounded_String_List is Unbounded_String_Vector_Package.Vector;
   function To_String( l : Unbounded_String_List ) return String;
   ...
   subtype Unbounded_String_Map is String_Maps_Package.Map;
