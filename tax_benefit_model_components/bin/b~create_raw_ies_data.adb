pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~create_raw_ies_data.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~create_raw_ies_data.adb");
with Ada.Exceptions;
...
package body ada_main is
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "za__ies__raw_io__finalize_spec");
      begin
         F1;
      end;
      E261 := E261 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "coicop_definitions__finalize_spec");
      begin
         F2;
      end;
      E253 := E253 - 1;
      declare
         procedure F3;
         pragma Import (Ada, F3, "zip__create__finalize_spec");
      begin
         F3;
      end;
      E241 := E241 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_create_raw_ies_data");
...
--  BEGIN Object file/option list
   ...
   --   /home/graham_s/VirtualWorlds/projects/tax_benefit_model_components/bin/create_raw_ies_data.o
