...
package body Raw_FRS is
   ...
   begin
      ...
      if( (a.ben1q6 /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "BEN1Q6 (In receipt: War Disablement Pens or War Widow(er)'s Pens) [ben1q6] : " & Format(a.ben1q6) & LINE_BREAK;
      end if;
      ...
      if( (a.ben5q4 /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "BEN5Q4 (Rcpt last 6 months Lone Parent's Run-On/Job Grant) [ben5q4] : " & Format(a.ben5q4) & LINE_BREAK;
      end if;
      if( (a.ben5q5 /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "BEN5Q5 (Rcpt last 6m: Work-Search Premium) [ben5q5] : " & Format(a.ben5q5) & LINE_BREAK;
      end if;
      if( (a.ben5q6 /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "BEN5Q6 (Rcpt last 6m: In-work credit) [ben5q6] : " & Format(a.ben5q6) & LINE_BREAK;
      end if;
      if( (a.ben5q7 /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "BEN5Q7 (Rcpt last 6m: Work-related activity premium) [ben5q7] : " & Format(a.ben5q7) & LINE_BREAK;
      end if;
      ...
      if( (a.chkdpn /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "CHKDPN (Check: group personal or group stakeholder pension?) [chkdpn] : " & Format(a.chkdpn) & LINE_BREAK;
      end if;
      ...
      if( (a.govpjsa /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "GOVPJSA (DWP paying direct for 1 or more JSAitems) [govpjsa] : " & Format(a.govpjsa) & LINE_BREAK;
      end if;
      ...
      if( (a.lnkref5 /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "LNKREF5 (Request for NINO too intrusive) [lnkref5] : " & Format(a.lnkref5) & LINE_BREAK;
      end if;
      if( (a.lnkref6 /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "LNKREF6 (Didn't understand data linkage request) [lnkref6] : " & Format(a.lnkref6) & LINE_BREAK;
      end if;
      if( (a.lnkref7 /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "LNKREF7 (Can't be bothered) [lnkref7] : " & Format(a.lnkref7) & LINE_BREAK;
      end if;
      if( (a.lnkref8 /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "LNKREF8 (Will result in unwanted further contact) [lnkref8] : " & Format(a.lnkref8) & LINE_BREAK;
      end if;
      ...
      if( (a.mntgov2 /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "MNTGOV2 (Maintenance paid via DWP/CSA/SSA) [mntgov2] : " & Format(a.mntgov2) & LINE_BREAK;
      end if;
      ...
      if( (a.sfrpjsa /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "SFRPJSA (Whether repaying SF loan from JSA) [sfrpjsa] : " & Format(a.sfrpjsa) & LINE_BREAK;
      end if;
      ...
      if( (a.sic /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "SIC (Standard Industrial Classification) [sic] : " & Format(a.sic) & LINE_BREAK;
      end if;
      ...
      if( (a.war1 /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "WAR1 (In receipt: War Disablement Pension) [war1] : " & Format(a.war1) & LINE_BREAK;
      end if;
      ...
      if( (a.wtclum2 /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "WTCLUM2 (In receipt: Regular payments via employer) [wtclum2] : " & Format(a.wtclum2) & LINE_BREAK;
      end if;
      ...
      if( (a.chbflg /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "CHBFLG (Ethnicity of Head of HOUSEHOL (Pub. 2003-04)) [chbflg] : " & Format(a.chbflg) & LINE_BREAK;
      end if;
      ...
      if( (a.empstatc /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "EMPSTATC (Adult Employment status - HBAI definition) [empstatc] : " & Format(a.empstatc) & LINE_BREAK;
      end if;
      ...
      if( (a.nhs1 /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "NHS1 (Whether prescriptions free) [nhs1] : " & Format(a.nhs1) & LINE_BREAK;
      end if;
      ...
      if( (a.prit /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "PRIT (Number of free prescriptions) [prit] : " & Format(a.prit) & LINE_BREAK;
      end if;
      if( (a.prscrpt /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "PRSCRPT (Last 4 weeks: whether NHS prescriptions) [prscrpt] : " & Format(a.prscrpt) & LINE_BREAK;
      end if;
      ...
      if( (a.whyfrpr1 /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "WHYFRPR1 (Free prescription because of a benefit) [whyfrpr1] : " & Format(a.whyfrpr1) & LINE_BREAK;
      end if;
      if( (a.whyfrpr2 /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "WHYFRPR2 (Free prescription because of cert HC2) [whyfrpr2] : " & Format(a.whyfrpr2) & LINE_BREAK;
      end if;
      if( (a.whyfrpr3 /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "WHYFRPR3 (Free prescription because of medical) [whyfrpr3] : " & Format(a.whyfrpr3) & LINE_BREAK;
      end if;
      if( (a.whyfrpr4 /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "WHYFRPR4 (Free prescription because require lens) [whyfrpr4] : " & Format(a.whyfrpr4) & LINE_BREAK;
      end if;
      if( (a.whyfrpr5 /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "WHYFRPR5 (Free prescription because pregnant) [whyfrpr5] : " & Format(a.whyfrpr5) & LINE_BREAK;
      end if;
      if( (a.whyfrpr6 /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "WHYFRPR6 (Free prescription because other reason) [whyfrpr6] : " & Format(a.whyfrpr6) & LINE_BREAK;
      end if;
   ...
   begin
      ...
      if( (a.incold /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "INCOLD (Total income between April 2006 and March 2007) [incold] : " & Format(a.incold) & LINE_BREAK;
      end if;
      ...
      if( (a.ecotypbu /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "ECOTYPBU (Economic status indicator - HBAI definition) [ecotypbu] : " & Format(a.ecotypbu) & LINE_BREAK;
      end if;
      if( (a.ecstatbu /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "ECSTATBU (BU Economic status-HBAI definition) [ecstatbu] : " & Format(a.ecstatbu) & LINE_BREAK;
      end if;
      ...
      if( (a.hbindbu /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "HBINDBU (BU - in receipt of HB, CTB, IS/PC indicator) [hbindbu] : " & Format(a.hbindbu) & LINE_BREAK;
      end if;
      if( (a.hbindbu2 /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "HBINDBU2 (BU - in receipt of HB, CTB, IS/PC/JSA[IB] indicator) [hbindbu2] : " & Format(a.hbindbu2) & LINE_BREAK;
      end if;
   ...
   begin
      ...
      if( (a.chearns2 /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "CHEARNS2 (Child Earnings: Trust) [chearns2] : " & Format(a.chearns2) & LINE_BREAK;
      end if;
   ...
   begin
      ...
      if( (a.menpolam /= MISS_R) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "MENPOLAM (Last prem on End. Policy/Pep/Isa/Unit T.) [menpolam] : " & Format(a.menpolam) & LINE_BREAK;
      end if;
      ...
      if( (a.menstyr /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "MENSTYR (Year (endowment/PEP etc) taken out) [menstyr] : " & Format(a.menstyr) & LINE_BREAK;
      end if;
      if( (a.month /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "MONTH_ (Month code (Source)) [month] : " & Format(a.month) & LINE_BREAK;
      end if;
   ...
   begin
      ...
      if( (a.cwathh /= MISS_R) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "CWATHH (household water charges) [cwathh] : " & Format(a.cwathh) & LINE_BREAK;
      end if;
      ...
      if( (a.lowmcbhc /= MISS_R) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "LOWMCBHC (Low income maker - If S_MC_BHC less than 60% of McClements median BHC income (MDMCBHC)) [lowmcbhc] : " & Format(a.lowmcbhc) & LINE_BREAK;
      end if;
      if( (a.lowmcahc /= MISS_R) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "LOWMCAHC (Low income maker - If S_MC_AHC less than 60% of McClements median AHC income (MDMCAHC)) [lowmcahc] : " & Format(a.lowmcahc) & LINE_BREAK;
      end if;
   ...
   begin
      ...
      if( (a.charge2 /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "CHARGE2 (Whether pay: Feu duty) [charge2] : " & Format(a.charge2) & LINE_BREAK;
      end if;
      ...
      if( (a.chrgamt2 /= MISS_R) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "CHRGAMT2 (Amount paid for feu duty) [chrgamt2] : " & Format(a.chrgamt2) & LINE_BREAK;
      end if;
      ...
      if( (a.chrgpd2 /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "CHRGPD2 (Pcode: amount paid for Feu duty) [chrgpd2] : " & Format(a.chrgpd2) & LINE_BREAK;
      end if;
      ...
      if( (a.stroths /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "STROTHS (Whether pay structural insurance) [stroths] : " & Format(a.stroths) & LINE_BREAK;
      end if;
      if( (a.strpd1 /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "STRPD1 (Pcode: Structural insurance - repayment) [strpd1] : " & Format(a.strpd1) & LINE_BREAK;
      end if;
      if( (a.strpd2 /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "STRPD2 (Pcode: Structural insurance - premium) [strpd2] : " & Format(a.strpd2) & LINE_BREAK;
      end if;
      ...
      if( (a.depchldh /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "DEPCHLDH (No. of dependent children in household) [depchldh] : " & Format(a.depchldh) & LINE_BREAK;
      end if;
      ...
      if( (a.hbindhh /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "HBINDHH (HH - in receipt of HB, CTB, IS/PC indicator) [hbindhh] : " & Format(a.hbindhh) & LINE_BREAK;
      end if;
      if( (a.hbindhh2 /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "HBINDHH2 (HH - in receipt of HB, CTB, IS/PC/JSA [IB]indicator) [hbindhh2] : " & Format(a.hbindhh2) & LINE_BREAK;
      end if;
      ...
      if( (a.hhsize /= MISS_R) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "HHSIZE (Number of People in HH - max of 7 (Pub.)) [hhsize] : " & Format(a.hhsize) & LINE_BREAK;
      end if;
   ...
   begin
      ...
      if( (a.expben08 /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "EXPBEN08 (Received Workplace nursery) [expben08] : " & Format(a.expben08) & LINE_BREAK;
      end if;
      if( (a.expben09 /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "EXPBEN09 (Received Childcare vouchers/employer contracted childcare) [expben09] : " & Format(a.expben09) & LINE_BREAK;
      end if;
      if( (a.expben10 /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "EXPBEN10 (Received Mobile phone) [expben10] : " & Format(a.expben10) & LINE_BREAK;
      end if;
      if( (a.expben11 /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "EXPBEN11 (Received Vouchers) [expben11] : " & Format(a.expben11) & LINE_BREAK;
      end if;
      ...
      if( (a.whynou11 /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "WHYNOU11 (Why last pay not usual: other) [whynou11] : " & Format(a.whynou11) & LINE_BREAK;
      end if;
   ...
   begin
      ...
      if( (a.endwpri2 /= MISS) or INCLUDE_MISSING ) then
         s := s & (num_indents*INDENT) & "ENDWPRI2 (Payments into a PEP or ISA) [endwpri2] : " & Format(a.endwpri2) & LINE_BREAK;
      end if;
