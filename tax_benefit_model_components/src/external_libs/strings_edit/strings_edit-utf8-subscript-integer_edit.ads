...
--        Subscript.Integer_Edit                   Spring, 2005       --
--  Interface                                                         --
...
with Strings_Edit.UTF8.Integer_Edit;
...
private
   package Edit is new Strings_Edit.UTF8.Integer_Edit (Number);
   procedure Get
             (  Source  : in String;
                Pointer : in out Integer;
                Value   : out Number'Base;
   ...
   function Value
            (  Source  : in String;
               ...
               ToFirst : Boolean        := False;
               ToLast  : Boolean        := False
            )  return Number'Base renames Edit.Value;
   procedure Put
             (  Destination : in out String;
                Pointer     : in out Integer;
                Value       : Number'Base;
   ...
   function Image
            (  Value   : Number'Base;
               Base    : Script_Base := 10;
               PutPlus : Boolean     := False
            )  return String renames Edit.Image;

end Strings_Edit.UTF8.Subscript.Integer_Edit;
