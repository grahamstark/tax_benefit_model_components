...
class EditInfo:
        ...
        def toXML( self, document ):
                ...
                setIntAttribute( elem, 'inputFileStartPos', self.inputFileStartPos );
        ...
        def fromXML( self, xml ):
                ...
                self.inputFileStartPos = getIntAttribute( xml, 'inputFileStartPos', self.outputFileStartPos );
