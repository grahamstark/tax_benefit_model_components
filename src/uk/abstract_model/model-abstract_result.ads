package Model.Abstract_Result is
   ...
   function Get( result : Personal_Result; which : Calculated_Incomes_Range ) return Amount  is abstract;
   procedure Set( result : in out Personal_Result;which : Broad_Calculated_Type; value : Amount ) is abstract;
   function Get( result : Personal_Result; which : Broad_Calculated_Type ) return Amount  is abstract;
   ...
   procedure Set( result : in out Benefit_Unit_Result;which : Broad_Calculated_Type; value : Amount ) is abstract;
   function Get( result : Benefit_Unit_Result; which : Broad_Calculated_Type ) return Amount  is abstract;
   ...
   procedure Set( result : in out Household_Result;which : Broad_Calculated_Type; value : Amount ) is abstract;
   function Get( result : Household_Result; which : Broad_Calculated_Type ) return Amount  is abstract;
