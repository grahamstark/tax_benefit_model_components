    ...
    begin
       ...
       when exponential =>
          declare
             ...
             fsmoothing_count : constant Real := Real( smoothing_count );
             ...
             growth : constant Real := log( v2 / v1 ) / ( fvperiods - fsmoothing_count );
          begin
             for t in 1 .. v2_v1_distance loop
                v( t + 1 ) := v1 * ( 1.0 + growth ) ** (( t  * smoothing_count ) - 1 );
             end loop;
             for t in v2_v1_distance + 1 .. periods loop
