# set terminal svg size 600,400 dynamic enhanced fname 'arial'  fsize 10 mousing name "prob2_6" butt solid 
# set output 'prob2.6.svg'
set format x "%2.0f"
set format y "%3.2f"
set key inside right top vertical Right noreverse enhanced autotitles box linetype -1 linewidth 1.000
set label 1 "mu" at 3.83333, 0.030486, 0 left norotate back nopoint offset character 0, 0, 0
set label 2 "sigma" at 5.23046, 0.173192, 0 left norotate back nopoint offset character 0, 0, 0
set arrow 1 from 3.33333, 0, 0 to 3.33333, 0.285546, 0 nohead back nofilled linetype -1 linewidth 1.000
set arrow 2 from 3.33333, 0.173192, 0 to 4.73046, 0.173192, 0 nohead back nofilled linetype -1 linewidth 1.000
set samples 200, 200
set style data lines
set ytics 0.00000,0.030486,0.304860 norangelimit
