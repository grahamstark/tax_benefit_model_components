...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_create_raw_ies_data" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#d2925c4f#;
   pragma Export (C, u00001, "create_raw_ies_dataB");
